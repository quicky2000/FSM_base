...
template <class T_SITUATION,class T_TRANSITION> class FSM: public FSM_if
{
	public:
		...
		FSM(string p_FSM_name,FSM_motor<T_SITUATION,T_TRANSITION> *p_motor,FSM_situation_analyzer<T_SITUATION,T_TRANSITION> *p_analyzer);
		virtual ~FSM(void);
